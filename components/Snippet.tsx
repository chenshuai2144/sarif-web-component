...
import { Hi } from './Hi';
import type { PhysicalLocation } from 'sarif';
    ...
    let body = tryOr(
      () => {
        ...
        return (
          <>
            {pre}
            <span className="swcRegion">{hi}</span>
            {post}
          </>
        );
      },
      ...
      <div style={{ padding: 15 }}>
        ...
        <Snippet
          ploc={{
            ...
            contextRegion: {
              snippet: {
                text: 'Surrounding. Content region. Surrounding. Currently not rendered if no startLine.',
              },
            },
          }}
        />
        ...
        <Snippet
          ploc={{
            ...
            region: {
              snippet: {
                text: '    Normalize indent: Currently does not apply if no context region (but maybe it should)',
              },
            },
          }}
        />
